...
class IsolatingFindHook(private var sandboxes: HashSet<Sandbox>) :  FindHook {
    ...
    override fun find(context: BundleContext, bundles: MutableCollection<Bundle>) {
        //println("hook ref class: " + FindHook::class.java.name + " " + FindHook::class.java.hashCode())

        val targetSandbox = context.bundle?.owningSandbox(sandboxes)
        val copyCandidates = bundles.toMutableList()
